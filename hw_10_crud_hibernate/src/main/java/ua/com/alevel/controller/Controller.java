...
public class Controller {
    ...
    private void menu() {
        ...
        System.out.println("                                                        ");
        System.out.println("If you want attach book to author, please enter 7            If you want to know if book exist by name, please enter 66");
        System.out.println("                                                        ");
        System.out.println("                                                            If you want detach book to author, please enter 77 ");
        System.out.println("                                                        ");
    ...
    private void existByName(BufferedReader reader) throws IOException {
        ...
        String name = reader.readLine();
        System.out.println(bookDao.existsByName(name));
    }

    private void attachBookToAuthor(BufferedReader reader) throws IOException {
        System.out.println("Enter the book id");
        Book book = bookDao.findById(Long.parseLong(reader.readLine())).get();
        System.out.println("Enter the author id");
        Author author = authorDao.findById(Long.parseLong(reader.readLine())).get();
        authorDao.attachBookToAuthor(book, author);
    }
    ...
    private void detachAuthorToBook(BufferedReader reader) throws IOException {
        ...
        System.out.println("Enter the author id");
        Author author = authorDao.findById(Long.parseLong(reader.readLine())).get();
        authorDao.detachBookToAuthor(book, author);
    }
}
